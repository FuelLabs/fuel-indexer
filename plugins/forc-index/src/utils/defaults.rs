...
[dependencies]
fuel-indexer-macros = {{ version = "0.16", default-features = false }}
fuel-indexer-plugin = {{ version = "0.16", features = ["native-execution"] }}
fuel-indexer-schema = {{ version = "0.16", default-features = false }}
...
[dependencies]
fuel-indexer-macros = {{ version = "0.16", default-features = false }}
fuel-indexer-plugin = {{ version = "0.16" }}
fuel-indexer-schema = {{ version = "0.16", default-features = false }}
