...
// ** THIS IS COPIED OVER FROM `forc-util` **
//
// This is a temporary measure until `forc-util` upgrades its `fuel-tx`
// to 0.31 (from 0.26). This is because `fuel-tx` 0.26 will conflict with
// the `fuel-tx` 0.31 that `fuels` uses over at https://github.com/FuelLabs/fuels-rs/pull/950
...
pub fn is_keyword(name: &str) -> bool {
    ...
    [
        "Self", "abstract", "as", "await", "become", "box", "break", "const", "continue",
        "dep", "do", "dyn", "else", "enum", "extern", "false", "final", "fn", "for",
        "if", "impl", "in", "let", "loop", "macro", "match", "move", "mut", "override",
        "priv", "pub", "ref", "return", "self", "static", "struct", "super", "trait",
