...
> Note: The following explanation is for demonstration purposes only. For an even simpler setup, you can use the [forc index postgres](../../reference-guide/plugins/forc-postgres/index.md) command. _A production setup should use secure users, permissions, and passwords._
