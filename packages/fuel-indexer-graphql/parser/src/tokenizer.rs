        ...
        match cur_char {
            '(' | '[' | '{' => {
                ...
                self.recursion_limit =
                    self.recursion_limit.checked_sub(1).ok_or_else(|| {
                        Error::message_static_message("Recursion limit exceeded")
                    })?;
...
mod test {
    ...
    fn int() {
        ...
        assert_eq!(
            tok_typ("a(x: 10) { b }"),
            [
                Name, Punctuator, Name, Punctuator, IntValue, Punctuator, Punctuator,
                Name, Punctuator
            ]
        );
    }
    ...
    fn float() {
        ...
        assert_eq!(
            tok_typ("a(x: 10.0) { b }"),
            [
                Name, Punctuator, Name, Punctuator, FloatValue, Punctuator, Punctuator,
                Name, Punctuator
            ]
        );
