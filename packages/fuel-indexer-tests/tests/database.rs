...
const SIMPLE_WASM_MANIFEST: &str =
    include_str!("./../../components/indexers/simple-wasm/simple_wasm.yaml");
const SIMPLE_WASM_GRAPHQL_SCHEMA: &str =
    include_str!("./../../components/indexers/simple-wasm/schema/simple_wasm.graphql");
const SIMPLE_WASM_WASM: &[u8] =
    include_bytes!("./../../components/indexers/simple-wasm/simple_wasm.wasm");
