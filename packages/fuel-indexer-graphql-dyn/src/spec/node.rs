...
#[extension_trait]
pub impl NodeObject for Object {
    fn new_node<Resolver: NodeResolver>(name: impl Into<String>) -> Self {
    ...
    fn data_field<Resolver: NodeResolver>(
        self,
    ...
    fn ref_field<Resolver: NodeResolver>(
        self,
        name: impl Into<String>,
        ty: impl Into<TypeRef>,
    ) -> Self {
    ...
    fn connection_field<Resolver: NodeResolver>(
        self,
        name: impl Into<String>,
        ty: impl Into<TypeRef>,
    ) -> Self {
